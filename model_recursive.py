...
class QDDETR(nn.Module):
    ...
    def forward(self, src_txt, src_txt_mask, src_vid, src_vid_mask, src_aud=None, src_aud_mask=None):
        ...
        # print("saliency_scores:", out["saliency_scores"][0, :10])
        # print("saliency_scores_neg:", out["saliency_scores_neg"][0, :10])
        # print("saliency_scores shape:", out["saliency_scores"].shape)
        # print("saliency_scores_neg shape:", out["saliency_scores_neg"].shape)
        
        ## recursive attention
        scores = out["saliency_scores"]
        ...
        hs2, reference2, memory2, memory_global2 = self.transformer(src2, ~mask2, self.query_embed.weight, pos2, video_length=video_length)
